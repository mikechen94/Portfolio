...
public class HelloWorldSpring {
    ...
    private static BeanFactory getBeanFactory() throws Exception {
        ...
        //@ original, changed to as next line. props.load(new FileInputStream("springdi/src/helloworld/beans.properties"));
		props.load(new FileInputStream("E:/SDP/day2/Explorer/HelloWorldSpring/" +
                "beans.properties"));
